...
function addCell(x, y, w, h, text, isHeader = false, isLaw = false) {
    ...
    elements.push({
        ...
        opacity: 100,
        angle: 0,
        roundness: null, // Sharp rectangle corners instead of rounded
        isDeleted: false,
...
addCell(colXs[3], 30, colWidths[3], headerHeight, "건축제한 근거규정 (시행령)", true);

// Rows definition
const rows = [
    // 도시지역 - 주거지역
    { parent1: "도시지역", parent2: "주거지역", name: "제1종 전용주거지역", law: "국토계획법 시행령 [별표 2]" },
    { parent1: "도시지역", parent2: "주거지역", name: "제2종 전용주거지역", law: "국토계획법 시행령 [별표 3]" },
    { parent1: "도시지역", parent2: "주거지역", name: "제1종 일반주거지역", law: "국토계획법 시행령 [별표 4]" },
    { parent1: "도시지역", parent2: "주거지역", name: "제2종 일반주거지역", law: "국토계획법 시행령 [별표 5]" },
    { parent1: "도시지역", parent2: "주거지역", name: "제3종 일반주거지역", law: "국토계획법 시행령 [별표 6]" },
    { parent1: "도시지역", parent2: "주거지역", name: "준주거지역", law: "국토계획법 시행령 [별표 7]" },
    // 도시지역 - 상업지역
    { parent1: "도시지역", parent2: "상업지역", name: "중심상업지역", law: "국토계획법 시행령 [별표 8]" },
    { parent1: "도시지역", parent2: "상업지역", name: "일반상업지역", law: "국토계획법 시행령 [별표 9]" },
    { parent1: "도시지역", parent2: "상업지역", name: "근린상업지역", law: "국토계획법 시행령 [별표 10]" },
    { parent1: "도시지역", parent2: "상업지역", name: "유통상업지역", law: "국토계획법 시행령 [별표 11]" },
    // 도시지역 - 공업지역
    { parent1: "도시지역", parent2: "공업지역", name: "전용공업지역", law: "국토계획법 시행령 [별표 12]" },
    { parent1: "도시지역", parent2: "공업지역", name: "일반공업지역", law: "국토계획법 시행령 [별표 13]" },
    { parent1: "도시지역", parent2: "공업지역", name: "준공업지역", law: "국토계획법 시행령 [별표 14]" },
    // 도시지역 - 녹지지역
    { parent1: "도시지역", parent2: "녹지지역", name: "보전녹지지역", law: "국토계획법 시행령 [별표 15]" },
    { parent1: "도시지역", parent2: "녹지지역", name: "생산녹지지역", law: "국토계획법 시행령 [별표 16]" },
    { parent1: "도시지역", parent2: "녹지지역", name: "자연녹지지역", law: "국토계획법 시행령 [별표 17]" },
    // 관리지역
    { parent1: "관리지역", parent2: "관리지역", name: "보전관리지역", law: "국토계획법 시행령 [별표 18]" },
    { parent1: "관리지역", parent2: "관리지역", name: "생산관리지역", law: "국토계획법 시행령 [별표 19]" },
    { parent1: "관리지역", parent2: "관리지역", name: "계획관리지역", law: "국토계획법 시행령 [별표 20]" },
    // 농림지역
    { parent1: "농림지역", parent2: "농림지역", name: "농림지역", law: "국토계획법 시행령 [별표 21]" },
    // 자연환경보전지역
    { parent1: "자연환경보전지역", parent2: "자연환경보전지역", name: "자연환경보전지역", law: "국토계획법 시행령 [별표 22]" }
];
...
rows.forEach((row, i) => {
    ...
    // 3. Name cell (Col 3) and Law cell (Col 4)
    addCell(colXs[2], currentY, colWidths[2], cellHeight, row.name);
    addCell(colXs[3], currentY, colWidths[3], cellHeight, row.law, false, true);
...
fs.writeFileSync('public/posts/web_blog/용도변경/data/draw3.excalidraw.md', fileTemplate, 'utf8');
console.log('Successfully generated draw3.excalidraw.md with sharp corner boxes!');

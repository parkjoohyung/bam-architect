...
const laws = [
    { id: 'parking_act', title: '주차장법', seq: '280143' },
    { id: 'parking_decree', title: '주차장법 시행령', seq: '273373' },
    { id: 'parking_rules', title: '주차장법 시행규칙', seq: '279253' }
];
...
(async () => {
    ...
    // Save to JSON
    fs.writeFileSync('d:/park/05.web/law_data_parking.json', JSON.stringify(resultData, null, 2));
    console.log('Done! Saved to law_data_parking.json');
